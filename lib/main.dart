...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String recyclableOrNot(String object){
    List recyclables = ["bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat", "traffic light", "fire hydrant", "stop sign", "parking meter", "bench", "backpack", "umbrella", "handbag", "tie", "suitcase", "frisbee", "bottle", "wine glass", "cup", "fork", "knife", "spoon", "bowl", "chair", "sofa", "tvmonitor", "laptop", "mouse", "remote", "keyboard", "cell phone", "microwave", "oven", "toaster"];
    List compostables = ["bird", "cat", "dog", "horse", "sheep", "cow", "elephant", "bear", "zebra", "giraffe", "banana", "apple", "sandwich", "orange", "broccoli", "carrot", "hot dog", "pizza", "donut", "cake"];
    if(recyclables.contains(object)){
      return "Recyclable";
    }
    else if(compostables.contains(object)){
      return "Compostables";
    }
    else{
